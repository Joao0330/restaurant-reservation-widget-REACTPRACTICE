...
import { ReservationFieldset } from './components/ReservationFieldset';
...
function App() {
	...
	return (
		<div className='min-h-dvh p-10 bg-gray-900 text-white'>
			...
			<Dialog open={isDialogOpen} as='div' className='relative  focus:outline-none' onClose={() => setIsDialogOpen(false)}>
						...
						{step === 'reservation-details' && (
							<>
								...
								<div className='flex gap-4'>
									<Button
										onClick={() => setStep('contact-details')}
